...
export default function () {
  const url = 'http://eoldev.prodam/_SE1426_WS_EOL_ONLINE/api/v1/unidade/pesquisar'
  const headers = {
  ...
  const payload = {
    "codigoUnidadeEducacao": "000191",
    "nomeUnidadeEducacao": "ALIPIO CORREA NETO, PROF.",
    "codigoDistritoMec": 94,
    "codigoTipoOrdenacao": 0,
    "codigoTipoLocalizacao": "string",
    "codigoTipoEndereco": "string",
    "codigoUnidadeAdministrativa": "string",
    "valorDistanciaMaxima": 0,
